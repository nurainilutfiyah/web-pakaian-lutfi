<div class="container">
      ...
      <div class="row">
				...
				$data_pegawai = mysqli_query($koneksi,"select * from produk limit $halaman_awal, $batas");
    ...
    <div class="container">
		<nav>
			<ul class="pagination justify-content-center">
				<li class="page-item">
					<a class="page-link" <?php if($halaman > 1){ echo "href='index.php?include=daftar_menu&halaman=$previous'"; } ?>>Previous</a>
				</li>
				<?php 
				...
				?>				
				<li class="page-item">
					<a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='index.php?include=daftar_menu&halaman=$next'"; } ?>>Next</a>
				</li>
			</ul>
		</nav>
  </div>
